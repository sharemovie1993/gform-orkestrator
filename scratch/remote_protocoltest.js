// scratch/remote_protocoltest.js
...
// Ambil sampel siswa dari Cloud
function getSampleStudents() {
  return new Promise((resolve) => {
    const u = new URL(`${CLOUD_SUPABASE_URL}/rest/v1/siswa?select=nisn,nama_siswa,kelas_id,kelas(nama_kelas)&tenant_id=eq.${TENANT_ID}&is_active=eq.true&order=nama_siswa&limit=${CONCURRENT}&offset=50`);
